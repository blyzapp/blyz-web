      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 flex flex-col gap-32">
        ...
        <section className="text-center flex flex-col items-center gap-6">
          ...
          <Image
            ...
            width={360}
            height={360}
            className="blyz-logo select-none"
            priority
          />

          <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight mt-4">
            About <span className="blyz-word">BLYZ</span>
          </h1>

          <p className="text-gray-300 max-w-3xl text-lg leading-relaxed">
            <span className="blyz-word">BLYZ</span> was created to bring{" "}
            <strong>modern technology, transparency, and reliability</strong> to winter
            services. We’re building the fastest, cleanest, and most trusted
            on-demand snow removal platform in Canada.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-10">
          <h2 className="text-2xl font-semibold text-center">
            Why We Built <span className="blyz-word">BLYZ</span>
          </h2>

          <div className="grid gap-6 sm:grid-cols-2">

            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 flex flex-col gap-3">
        ...
        <section className="text-center flex flex-col gap-6">
          <h2 className="text-2xl font-semibold">
            Our Mission at <span className="blyz-word">BLYZ</span>
          </h2>

          <p className="text-gray-300 max-w-3xl mx-auto text-lg leading-relaxed">
            To make winter maintenance <strong>effortless</strong>,{" "}
            <strong>transparent</strong>, and <strong>accessible</strong> —
            for both homeowners and operators.
            <span className="blyz-word"> BLYZ</span> brings modern technology to a
            service that desperately needs an upgrade.
          </p>
        </section>
        ...
        <section className="flex flex-col items-center gap-6 text-center">
          <h2 className="text-3xl font-semibold">
            Be First in Line When <span className="blyz-word">BLYZ</span> Launches ❄️
          </h2>
